...
Erc20Controller.prototype.getInfo = function(req, res) {
    ...
    return async.waterfall([function (callback) {
        ...
        if (returnData.contract.symbol == 'HTML' || (returnData.contract.symbol == 'SVM') ||
            (returnData.contract.symbol == 'SVN') || (returnData.contract.symbol == 'HTMT'))
        {
            return res.jsonp({
...
Erc20Controller.prototype.getBalances = function(req, res) {
    var self = this,
        ...
        addresses = req.query.addresses || [],
        queryOptions = self._formatQueryOptions({
            limit: limit, offset: offset, addresses: addresses, sort: sort
        }),
        dataFlow = {
            contract: null,
            countBalances: 0,
